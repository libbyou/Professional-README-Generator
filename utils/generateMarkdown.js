...
function renderLicenseLink(license) {
  if (license !== "None") {
    return `For more information about the license used for this project, please refer to the [${data.license} license](https://choosealicense.com/licenses/${license}/).`;
  } else {
    return("");
  }
}
